...
כשהמאגר ציבורי זה עובד ישר, בלי שום הגדרה. אם המאגר פרטי, ההורדה דורשת אימות
ויש שתי דרכים:

1. **פתיחת דף ההורדה** (הכפתור השני) — נפתח בדפדפן שבו כבר התחברתם ל-GitHub,
   מורידים ומתקינים.
2. **טוקן** — מדביקים בשדה שבאותו מסך טוקן קריאה בלבד למאגר
...
לא מועבר הלאה לשרת ההורדה שאליו GitHub מפנה.
